        ...
        <div className="flex flex-col w-full">
          ...
          {isPDF && (
            <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
              <FileIcon className="h-10 w-10 fill-indigo-200 stroke-slate-400" />
              <a
                href={fileUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="ml-2 flex-1 text-xs text-indigo-500 dark:text-indigo-400 hover:underline truncate"
              >
                PDF File
              </a>
            </div>
